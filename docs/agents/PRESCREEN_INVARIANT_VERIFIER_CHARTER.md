...
owner: Tyler Hebert (product authority); technical and evaluation owners pending OD-15
version: 0.2.0
created: 2026-07-29
scope: Read-only repository review tooling; not a Clarity product AI agent
related_decisions: OD-9, OD-15, OD-16, OD-17, OD-18, OD-19
...
This charter does not authorize execution. OD-15 and
...
4. Read ADR-0013 and ADR-0014, then OD-9, OD-15, OD-16, OD-17, OD-18, OD-19,
   and relevant risks.
...
Only after Stage 1 passes, OD-9 hermetic verification is accepted, OD-18 is
...
These rules are proposed and require OD-15 approval.
...
- OD-15 has not approved or staffed the evaluation.
- OD-18 has not selected one canonical governance/evaluation model.
...
- Current `main` adds a comprehensive enum-sync guard in PR #36 and narrows its
  ...
  #38. Remaining semantics are blocked on OD-17, medical-diversion role
  authority is blocked on OD-19, and neither current-main change has been
