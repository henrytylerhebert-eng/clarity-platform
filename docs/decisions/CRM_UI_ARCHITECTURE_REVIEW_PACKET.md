...
- Behavioral health providers, including central-intake organizations partnered with specific ERs.
- Behavioral health parent companies, with child profiles for each location, program, service line, and personnel group.
- Case management and discharge planning users who need resource search by disposition across inpatient, rehab, outpatient, nursing, primary care, specialist, and community resources.
