...
> branch. This is a **2026-09-12 snapshot** against `main` at `15a094d`; treat its statuses
> as historical to that date. A separate, newer tree snapshot (2026-09-16) lives at
> [`../architecture/CLARITY_PLATFORM_TREE.md`](../architecture/CLARITY_PLATFORM_TREE.md),
> preserved by PR #101. Neither is authoritative for capability — the documents each links
> to are. Where the two trees disagree, prefer the newer one and verify against code.
