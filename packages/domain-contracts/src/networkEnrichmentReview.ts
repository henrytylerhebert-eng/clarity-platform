 ...
 *
 * ADR-0019 note: this module is the human-review / persistence-workflow
 * half of network enrichment: submit/approve/reject/reconcile command
 * contracts, review-state transitions, role-alias mapping, audit events,
 * and compliance export shapes. It is a sibling to
 * `networkEnrichmentResolution.ts` (the entity-resolution /
 * candidate-data-quality half), not a replacement for it.
 *
 ...
 *
 * Known gaps preserved as-is, not fixed by ADR-0019 (flagged for a separate
 * follow-up, since this task is a contract kernel, not a service/runtime
 ...
 * definitions, and is unchanged by this contract-kernel adoption.
 */
