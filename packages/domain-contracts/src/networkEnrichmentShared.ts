 ...
 * local to their owning module. See ADR-0019 for the adoption boundary.
 *
 * Nothing here does I/O, persistence, or canonical mutation.
 */

/**
 * The enrichment package wire-format version. Moved into this shared module
 * because it is the version tag a future stitching layer will use to check
 * compatibility between what resolution produced and what review/persistence
 * consumes. Literal value and export name are unchanged.
 */
 ...
 * change any existing exported schema, field name, or validation behavior in
 * either module. Introducing real nominal branding would be a design change
 * beyond ADR-0019 and is intentionally not done here.
 */
