...
Deliverables: 388/389 root tests (the 1 is the shared-clarity_dev migration-ledger failure, issue #31 — CI green), 64/64 app; 145/145 prescreen source-package checksums; tag clarity-foundation-v0.1; ADR-0001…0018 on main (0015–0017 exist only on unmerged branches — always check ADR numbers across all refs, not just main)
