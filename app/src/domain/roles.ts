...
export const roles: RoleDefinition[] = [
  ...
  },
  {
    ...
    workspaces: ["new", "directory-crm", "intake", "overview", "ledger", "training", "mock-admits"],
  ...
  },
  {
    ...
    workspaces: ["command", "directory-crm", "queue", "new", "overview", "intake", "evidence", "medical", "legal", "benefits", "authorization", "episode", "packet", "routing", "ledger", "training", "mock-admits"],
  ...
  },
  {
    ...
    workspaces: ["directory-crm", "queue", "overview", "intake", "evidence", "medical", "legal", "episode", "ledger", "training", "mock-admits"],
    defaultWorkspace: "queue",
  },
  {
    id: "ur",
    ...
    workspaces: ["command", "directory-crm", "queue", "overview", "medical", "benefits", "authorization", "episode", "ledger", "training", "mock-admits"],
  ...
  },
  {
    ...
    workspaces: ["directory-crm", "packet", "routing", "ledger", "training", "mock-admits"],
  ...
  },
  {
    ...
    workspaces: ["directory-crm", "bedboard", "overview", "ledger", "training", "mock-admits"],
  ...
  },
  {
    ...
    workspaces: ["command", "directory-crm", "queue", "evidence", "legal", "ledger", "training", "mock-admits"],
  ...
  },
  {
    ...
    workspaces: ["command", "directory-crm", "queue", "ledger", "training", "mock-admits", "studio"],
    defaultWorkspace: "command",
  },
];
