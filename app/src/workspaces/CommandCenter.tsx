    ...
    <div className="stack">
      <section className="panel">
        <div className="panel-title">
          <div className="icon-title"><LayoutDashboard size={18} /><h2>Intake overview</h2></div>
          <p>Synthetic operational view. Clock targets are configurable demo values, not statutory truth. Financial status remains separate from clinical progression.</p>
        </div>
        ...
        <footer className="panel-footer">Escalation reflects configured demo clock targets. No production timing or outcome claim is made.</footer>
      </section>
    </div>
  );
}
